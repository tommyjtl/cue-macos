...
- [x] **Export chat context with `/save`** — `/save` (aliases `/note`, `/notes`) writes structured markdown to a user-chosen folder under `{folder}/{yyyy-MM-dd}/`. Settings → Commands. <mark>Jun 4, 2026</mark>
